...
| R2 | Concept presence: word-boundary matching (RG-009 lever; de-confounds R5) | built (2026-07-02, staged) — `mode="boundary"` default + `substring` A/B lever; 706 tests green; before/after measurement deferred to R5 | `docs/specs/remediation-plan-2026-07.md` |
