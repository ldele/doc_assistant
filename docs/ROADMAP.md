...
| U3 | UI: citation side panel — click inline `[n]` to open a slide-over with that source's chunk detail (Chainlit-style); source cards no longer render inline by default | **`SPRINT-009` flipped to active 2026-07-10** (U2 landed, no sibling to archive) — next up, 2nd in build order; design-locked (grilled 2026-07-10) | `docs/sprints/SPRINT-009-citation-side-panel.md` · `docs/specs/feature-phase8-ui-upgrade.md` |
