...
| E1.2 | `_handle_rag` extraction (~287 lines / ~14 responsibilities) into staged steps — before E2/E3 wire epistemics into it (code-health, opportunistic) | planned | `docs/PLAN_2026-07-21_exploration-epistemics.md` |
