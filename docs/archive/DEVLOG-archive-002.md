<!-- status: archived · updated: 2026-08-15 · class: append-only -->

# DEVLOG — archive 002 (2026-07-15 → 2026-08-01 (6))

Older entries, moved verbatim from `docs/DEVLOG.md` on 2026-08-15 so the working log stays about
recent work. Newest-first, same format, unedited. The live log continues from 2026-08-02 onward.
Rotated because the live log had reached 8,244 lines / 623 KB — see the cap in
`tests/unit/test_doc_sizes.py`, which now fails before it can grow that far again.
