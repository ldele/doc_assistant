<!-- status: active · updated: 2026-09-16 (S-1 + S-2 done: size caps and the walk cap; S-3 next; §0 + §4: one step per session; §6: the periodic full check) · class: living -->
