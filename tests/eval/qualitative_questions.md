...
## Cajal Lecture (`cajal-lecture.pdf`)

### Q: What is the central scientific claim Cajal is defending?

The claim is the neuron doctrine:
...
Cajal is arguing:
- The brain is made of discrete computational units.
- Organized into directional circuits.
- Connected through specialized interfaces.

That became one of the foundations of modern neuroscience.

**Key idea:** "contiguity but not continuity"

---

### Q: Why is this lecture historically important?

Because it is one of the major moments where modern neuroscience crystallized.

Cajal:
- Used microscopic staining methods.
- Mapped neural circuits.
- Inferred signal directionality.
- Proposed functional organization from anatomy.

Several concepts introduced or defended here became foundational:
- Neuron doctrine
- Dynamic polarization
- Synaptic organization (before the word "synapse" was fully established)
- Axonal growth cones
- Neural plasticity / regeneration concepts

The "dynamic polarization" principle is especially important:
...
### Q: What is most striking when reading it today?
